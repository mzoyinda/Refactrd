      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link
              href="/"
              className="text-3xl font-bold text-purple-600 hover:text-purple-700 transition-colors duration-200"
            >
              Refactrd
            </Link>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-100">
            <span className="text-2xl font-bold text-purple-600">Refactrd</span>
            <button
              onClick={() => setMobileMenuOpen(false)}
          ...
          <nav className="p-6 space-y-2">
            {navLinks.map((link, index) => (
              <Link
                ...
                style={{
                  animation: mobileMenuOpen ? `slideInRight 0.3s ease-out ${index * 0.1}s both` : 'none',
                }}
              >
                {link.name}
              </Link>
