...
function ShareButtons({ title, slug }: { title: string; slug: string }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="font-clash font-bold text-xs text-[#94A3B8] uppercase tracking-widest">
        Share
      </span>
      ...
      <button
        ...
        className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 ${
          copied ? "bg-emerald-500" : "bg-[#E6EAF0] hover:bg-[#CBD5E1]"
        }`}
      >
        {copied
  ...
  if (notFound || !caseStudy) {
    return (
      <div className="min-h-screen flex items-center justify-center flex-col gap-4 pt-32">
        ...
        <p className="font-jakarta text-[#64748B]">This case study may have been removed.</p>
        <Link href="/case-studies" className="inline-flex items-center gap-2 px-6 py-3 bg-[#1F2A44] text-white rounded-full font-clash font-semibold text-sm hover:bg-[#0e5d7d] transition-all">
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-[#E6EAF0] via-white to-white pt-28 pb-10">
        <div className="container-custom max-w-4xl mx-auto">
          ...
          {/* Excerpt */}
          <p className="font-jakarta text-lg text-[#64748B] leading-relaxed mb-10 max-w-3xl">
            {caseStudy.excerpt}
          </p>
      ...
      <div className="bg-white py-10">
        <div className="container-custom max-w-4xl mx-auto">
          {caseStudy.featured_image_url ? (
            ...
            /* Clean gradient banner - no inline style background-image */
            <div className="w-full h-[360px] lg:h-[440px] rounded-2xl overflow-hidden bg-gradient-to-br from-[#1F2A44] to-[#0e5d7d] relative flex items-end">
              {/* Dot grid using pseudo-approach with divs */}
              ...
              {/* Giant faded letter */}
              <span className="absolute right-10 top-1/2 -translate-y-1/2 font-clash font-bold text-white select-none pointer-events-none"
                style={{ fontSize: 'clamp(10rem, 25vw, 20rem)', opacity: 0.05, lineHeight: 1 }}
              >
              ...
              <div className="relative z-10 p-10 lg:p-14">
                {caseStudy.industry && (
                  <span className="inline-block px-3 py-1.5 border border-white/20 bg-white/10 text-white text-xs font-clash font-bold rounded-full uppercase tracking-wide mb-4">
                    {caseStudy.industry}
                  </span>
                )}
                <h2 className="font-clash font-bold text-white text-2xl lg:text-3xl leading-tight max-w-2xl">
                  {caseStudy.title}
                </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {caseStudy.metrics.map((metric, i) => (
                <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-6">
                  <p className="font-clash font-bold text-3xl lg:text-4xl text-white mb-3">{metric.value}</p>
                  <p className="font-jakarta text-sm text-white/60 leading-relaxed">{metric.label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-3xl space-y-10">
            ...
            {caseStudy.problem && (
              <div>
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="font-clash font-bold text-xl text-[#1F2A44] uppercase tracking-wider">
                    The Challenge
                  </h2>
                </div>
                <div
            ...
            {caseStudy.testimonial_quote && (
              <div className="bg-[#F4F6F9] rounded-2xl p-8 lg:p-10 border-l-4 border-[#A2D2FF]">
                ...
                <p className="font-clash text-xl lg:text-2xl text-[#1F2A44] leading-relaxed mb-5 font-medium">
                  "{caseStudy.testimonial_quote}"
                </p>
      ...
      <section className="bg-[#1F2A44] py-24">
        <div className="container-custom max-w-4xl mx-auto text-center">
          ...
          <p className="font-jakarta text-white/60 mb-10 leading-relaxed max-w-lg mx-auto">
              ...
              {related.map((cs) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    {cs.industry && (
                      <span className="inline-block px-2.5 py-1 bg-[#E6EAF0] text-[#1F2A44] text-xs font-clash font-bold rounded-full mb-4 self-start">
                        {cs.industry}
                      </span>
                    )}
                    <h3 className="font-clash font-bold text-[#1F2A44] mb-3 group-hover:text-[#0e5d7d] transition-colors line-clamp-2 leading-snug">
                      {cs.title}
                    </h3>
                    <p className="font-jakarta text-sm text-[#64748B] line-clamp-2 flex-1 leading-relaxed">
                      {cs.excerpt}
                    </p>
