...
//             <Link
//               href="/"
//               className="text-secondary font-clash font-semibold text-[15px] hover:text-accent transition-colors duration-200 relative group"
//             >
//               Home
...
//             >
//               <button className="text-secondary font-clash font-semibold text-[15px] hover:text-accent transition-colors duration-200 flex items-center gap-1.5 group">
//                 Company
//                 <ChevronDown
...
//               {companyOpen && (
//                 <div className="absolute top-full left-0 mt-3 w-56 bg-white rounded-xl shadow-xl border border-tertiary overflow-hidden animate-fade-in">
//                   <div className="py-2">
//                     {company.map((item) => (
//                       <Link
//                         key={item.name}
//                         href={item.href}
//                         className="block px-6 py-3 text-secondary font-clash font-medium hover:bg-tertiary hover:text-accent transition-colors duration-200"
//                       >
//                         {item.name}
//                       </Link>
//                     ))}
...
//                             key={item.name}
//                             href={item.href}
//                             className="block px-4 py-2 text-sm text-secondary/80 font-clash hover:text-accent hover:bg-tertiary/50 rounded-lg transition-colors duration-200"
//                             onClick={() => setMobileMenuOpen(false)}
//                           >
//                             {item.name}
//                           </Link>
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-10">
            ...
            <div
              ...
              onMouseLeave={() => setCompanyOpen(false)}
            >
              <button className="text-secondary font-clash font-semibold text-[16px] hover:text-accent transition-colors duration-200 flex items-center gap-1.5 relative">
                Company
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-300 ${companyOpen ? "rotate-180" : ""}`}
                />
              ...
              {companyOpen && (
                <div className="absolute top-full left-0 pt-3 animate-fade-in">
                  <div className="w-56 bg-white rounded-xl shadow-xl border border-tertiary overflow-hidden">
                    <div className="py-2">
                      {company.map((item) => (
                        <Link
                          key={item.name}
