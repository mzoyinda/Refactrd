            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8">
              ...
              <div className="flex-shrink-0">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-[#1F2A44] text-[#E6EAF0] rounded-full font-clash font-bold hover:bg-[#1f2a44d2] transition-all duration-300 hover:scale-105 group whitespace-nowrap"
                >
