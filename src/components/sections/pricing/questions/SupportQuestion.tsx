        ...
        return (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="w-8 h-8 rounded-full border-2 border-[#CBD5E1] group-hover:border-primary group-hover:bg-primary flex items-center justify-center transition-all duration-300">
            ...
            {/* Description */}
            <p className="font-clash text-[#64748B] text-sm">{option.description}</p>
          </button>
        );
      })}
    </div>
