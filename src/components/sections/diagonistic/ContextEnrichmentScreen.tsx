    ...
    <div className="min-h-screen bg-black/75 flex items-center justify-center p-4">
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl">
          ...
          <div className="mb-8">
            <div className="flex items-start gap-3 mb-5">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-clash font-bold text-[#1F2A44] mb-1">
                  ...
                  <span className="text-base font-normal text-[#64748B] ml-2">(Optional)</span>
                </h2>
                <p className="text-sm text-[#64748B] font-jakarta">
                  This helps us tailor specific recommendations for your situation
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full h-36 px-5 py-4 border-3 border-black rounded-xl focus:outline-none focus:border-black focus:shadow-lg transition-all font-jakarta text-[#1F2A44] placeholder:text-[#94A3B8] resize-none"
              />
            ...
            <p className="mt-3 text-sm text-[#64748B] font-jakarta italic">
              💡 Tip: Be specific! Mention tools, processes, or pain points for better insights
            </p>
          </div>
          ...
          >
            <span>{isValid ? 'Get My AI Roadmap' : 'Select Team Size First'}</span>
            <ArrowRight className={`w-6 h-6 ${isValid ? 'animate-pulse' : ''}`} />
          </button>
        </div>

        {/* Footer - More Reassuring */}
        <p className="text-center text-sm text-white/80 font-jakarta mt-6">
          🔒 Your information is confidential and will only be used to generate your personalized report
        </p>
      </div>
    </div>
  );
