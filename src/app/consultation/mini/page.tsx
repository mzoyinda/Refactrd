...
// import { ArrowRight, ArrowLeft, CheckCircle, Loader2, Link2, Check } from "lucide-react";
...
//               A focused 60-minute session to identify your biggest AI opportunities, map quick wins, and give you a written action plan.
//               <span className="block mt-2">Fill in the intake below, then complete your payment to confirm your session.</span>
//             </p>
...
//                 <p className="font-jakarta text-white/55 text-sm">Help us understand your organization so we can make the most of your session.</p>
//               </div>
...
//                   <textarea name="prompt" value={form.prompt} onChange={handleChange} rows={4}
...
//                   <textarea name="desired_outcome" value={form.desired_outcome} onChange={handleChange} rows={4}
...
//                     Next step: choose your payment method and confirm your session.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                 <p className="font-jakarta text-white/55 text-sm">Choose how you would like to pay to confirm your session.</p>
//               </div>
...
//                     <div>
//                       <p className="font-clash font-bold text-[#1F2A44]">AI Opportunity Diagnostic</p>
//                       <p className="font-jakarta text-xs text-[#94A3B8] mt-1">60-min session + written AI opportunity map</p>
//                       <p className="font-jakarta text-xs text-[#94A3B8] mt-0.5">Booked for: {form.name} · {form.company}</p>
//                     </div>
          ...
          {step === "form" && (
            <div className="bg-white rounded-3xl border border-[#DDE3EE] shadow-sm overflow-hidden">
              ...
              <div className="px-6 py-8 md:px-10 md:py-10 space-y-6">
                ...
                <div>
                  <label className={labelCls}>What prompted you to explore AI right now? *</label>
                  <textarea name="prompt" value={form.prompt} onChange={handleChange} rows={4} placeholder="Tell us what sparked the conversation internally." className={`${inputCls} resize-none`} />
                </div>
                <div>
                  <label className={`${labelCls} mb-3`}>Where do you believe the biggest opportunities exist? *</label>
                  <div className="grid grid-cols-2 gap-2.5">
                ...
                <div>
                  <label className={labelCls}>What are the biggest operational challenges today? *</label>
                  <textarea name="challenges" value={form.challenges} onChange={handleChange} rows={4} placeholder="Describe bottlenecks, inefficiencies, or recurring challenges." className={`${inputCls} resize-none`} />
                </div>
                <div>
                  <label className={labelCls}>What outcome would make this diagnostic valuable? *</label>
                  <textarea name="desired_outcome" value={form.desired_outcome} onChange={handleChange} rows={4} placeholder="What would success look like after this engagement?" className={`${inputCls} resize-none`} />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="font-jakarta text-xs text-[#94A3B8] text-center">Next step: choose your payment method and confirm your session.</p>
                </div>
              </div>
            </div>
          )}
